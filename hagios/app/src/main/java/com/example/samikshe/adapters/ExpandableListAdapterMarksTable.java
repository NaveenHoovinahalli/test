...
public class ExpandableListAdapterMarksTable extends AnimatedExpandableListView.AnimatedExpandableListAdapter {

	private Context _context;
	private List<String> _listDataHeader; // header titles
	// child data in format of header title, child title
	private HashMap<String, List<Marks>> _listDataChild;
	View bttomLine;
	TextView subjectTV,totalMarksTV,obtainedTV,gradeTV;
	TextView date;

	public ExpandableListAdapterMarksTable(Context context, List<String> listDataHeader,
										   HashMap<String, List<Marks>> listChildData) {
...
//		if ( childPosition % 2 == 0 )
		...
		final Marks marks = (Marks) getChild(groupPosition, childPosition);




		subjectTV.setText(marks.getSubject());
		totalMarksTV.setText(marks.getMaximumMarks());
		obtainedTV.setText(marks.getObtainedMarks());
		gradeTV.setText(marks.getGrade());
